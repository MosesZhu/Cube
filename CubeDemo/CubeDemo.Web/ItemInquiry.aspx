            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-xs-6">
                    <div class="btn-toolbar" role="toolbar" style="float: right;">                        
                        <button type="button" class="btn btn-skin-primary" onclick="return createItem();" lang="lang_new">
                            Inquiry
                        </button>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-danger" onclick="return saveItem()" lang="lang_save">Save</button>
