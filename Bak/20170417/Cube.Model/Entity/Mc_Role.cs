...
namespace Cube.Model.Entity
{
    ...
    /// </summary>
    [Serializable]
    public class Mc_Role : ITS.Data.EntityBase
    {
        public Mc_Role() : base("mc_role") { }
        ...
        public class _
        {
            ...
            /// * 
            /// </summary>
            public readonly static Field All = new Field("*", "mc_role");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field Id = new Field("id", "mc_role", DbType.Guid, 16, "id");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field Name = new Field("name", "mc_role", DbType.String, 100, "name");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field Created_At = new Field("created_at", "mc_role", DbType.DateTime, 8, "created_at");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field Created_By = new Field("created_by", "mc_role", DbType.String, 100, "created_by");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field Modified_At = new Field("modified_at", "mc_role", DbType.DateTime, 8, "modified_at");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field Modified_By = new Field("modified_by", "mc_role", DbType.String, 100, "modified_by");
        }
        #endregion
