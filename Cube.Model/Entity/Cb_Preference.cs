...
namespace Cube.Model.Entity
{
	...
	/// </summary>
	[Serializable]
	public class Cb_Preference : ITS.Data.EntityBase
	{
		public Cb_Preference():base("cb_preference") {}
		...
		public class _
		{
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*","cb_preference");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field User_Id = new Field("user_id","cb_preference",DbType.Guid,16,"user_id");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field Language_Key = new Field("language_key","cb_preference",DbType.String,400,"language_key");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field Skin = new Field("skin","cb_preference",DbType.String,400,"skin");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field Created_At = new Field("created_at","cb_preference",DbType.DateTime,8,"created_at");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field Created_By = new Field("created_by","cb_preference",DbType.String,100,"created_by");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field Modified_At = new Field("modified_at","cb_preference",DbType.DateTime,8,"modified_at");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field Modified_By = new Field("modified_by","cb_preference",DbType.String,100,"modified_by");
		}
		#endregion
