...
namespace Cube.Model.Entity
{
	...
	/// </summary>
	[Serializable]
	public class Cb_Language : ITS.Data.EntityBase
	{
		public Cb_Language():base("cb_language") {}
		...
		public class _
		{
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*","cb_language");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field Language_Key = new Field("language_key","cb_language",DbType.String,400,"language_key");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field Zh_Cn = new Field("zh_cn","cb_language",DbType.String,-1,"zh_cn");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field Zh_Tw = new Field("zh_tw","cb_language",DbType.String,-1,"zh_tw");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field En_Us = new Field("en_us","cb_language",DbType.String,-1,"en_us");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field Createed_At = new Field("createed_at","cb_language",DbType.DateTime,8,"createed_at");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field Created_By = new Field("created_by","cb_language",DbType.String,100,"created_by");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field Modified_At = new Field("modified_at","cb_language",DbType.DateTime,8,"modified_at");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field Modified_By = new Field("modified_by","cb_language",DbType.String,100,"modified_by");
		}
		#endregion
