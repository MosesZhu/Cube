...
namespace Cube.Model.Entity
{
    ...
    /// </summary>
    [Serializable]
    public class Cb_Function : ITS.Data.EntityBase
    {
        public Cb_Function() : base("cb_function") { }
        ...
        public class _
        {
            ...
            /// * 
            /// </summary>
            public readonly static Field All = new Field("*", "cb_function");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field Id = new Field("id", "cb_function", DbType.Guid, 16, "id");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field Code = new Field("code", "cb_function", DbType.String, 100, "code");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field System_Id = new Field("system_id", "cb_function", DbType.String, 400, "system_id");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field Parent_Function_Id = new Field("parent_function_id", "cb_function", DbType.String, 400, "parent_function_id");
            /// <summary>
            /// 
            /// </summary>
            ...
            /// 
            /// </summary>
            public readonly static Field Url = new Field("url", "cb_function", DbType.String, -1, "url");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field Created_At = new Field("created_at", "cb_function", DbType.DateTime, 8, "created_at");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field Created_By = new Field("created_by", "cb_function", DbType.String, 100, "created_by");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field Modified_At = new Field("modified_at", "cb_function", DbType.DateTime, 8, "modified_at");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field Modified_By = new Field("modified_by", "cb_function", DbType.String, 100, "modified_by");
        }
        #endregion
